...
export default function Plans() {
  ...
  return (
    <div className="px-5 pt-6 safe-top">
      ...
      {/* Tab Toggle */}
      <div className="flex mt-4 bg-muted rounded-2xl p-1">
      ...
      {activeTab === "my-plans" ? (
        <div className="mt-4 space-y-4">
          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              { label: "Streak", value: "7", icon: Flame, color: "text-primary" },
              { label: "Workouts", value: "24", icon: Trophy, color: "text-primary" },
              { label: "This Month", value: "12", icon: Calendar, color: "text-primary" },
            ].map((stat) => (
              <div key={stat.label} className="p-3 rounded-2xl bg-card card-shadow text-center">
                <div className="w-8 h-8 mx-auto rounded-xl bg-primary/15 flex items-center justify-center mb-1">
        ...
        <div className="mt-4 space-y-3">
          {programs.map((program, i) => (
            <motion.button
              ...
              className="w-full p-4 rounded-2xl bg-card card-shadow text-left group flex items-center gap-3"
            >
